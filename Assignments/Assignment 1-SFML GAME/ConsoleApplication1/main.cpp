...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        //------------------------event---------------------------------------
        if (CGreen.getPosition().x < 0)
        {
            ix_CGreen = -ix_CGreen;
        }
        if (CBlue.getPosition().x < 0)
        {
            ix_CBlue = -ix_CBlue;
        }
        if (CPurple.getPosition().x < 0)
        {
            ix_CPurple = -ix_CPurple;
        }
        if (RRed.getPosition().x < 0)
        {
            ix_RRed = -ix_RRed;
        }
        if (RGreen.getPosition().x < 0)
        {
            ix_RGreen = -ix_RGreen;
        }
        if (RTeal.getPosition().x < 0)
        {
            ix_RTeal = -ix_RTeal;
        }

        if (CGreen.getPosition().y< 0)
        {
            iy_CGreen = -iy_CGreen;
        }
        if (CBlue.getPosition().y < 0)
        {
            iy_CBlue = -iy_CBlue;
        }
        if (CPurple.getPosition().y < 0)
        {
            iy_CPurple = -iy_CPurple;
        }
        if (RRed.getPosition().y < 0)
        {
            iy_RRed = -iy_RRed;
        }
        if (RGreen.getPosition().y < 0)
        {
            iy_RGreen = -iy_RGreen;
        }
        if (RTeal.getPosition().y < 0)
        {
            iy_RTeal = -iy_RTeal;
        }
        //------------------------motion----------------------------------------
